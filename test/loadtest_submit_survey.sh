...
NUMBER=$1
CONCURRENT=$2
TARGET_URL="http://docs.google.com/a/thoughtworks.com/spreadsheet/formResponse?formkey=dHpTckZwb0ZzSGNycVh0dkN4R0puRnc6MQ&ifq"
...
ab -n $NUMBER -c $CONCURRENT -p post_data.txt -v 1 -g results.gnu -e results.csv -T 'application/x-www-form-urlencoded' $TARGET_URL
